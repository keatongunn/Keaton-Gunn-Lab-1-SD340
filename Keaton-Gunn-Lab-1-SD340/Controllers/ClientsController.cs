...
namespace Keaton_Gunn_Lab_1_SD340.Controllers
{
    public class ClientsController : Controller
    {
        private readonly Keaton_Gunn_Lab_1_SD340Context _context;

        public ClientsController(Keaton_Gunn_Lab_1_SD340Context context)
        {
            _context = context;
        }
